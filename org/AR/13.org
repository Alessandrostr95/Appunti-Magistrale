...
* Sistema di Voto Individuale
  ...
  - Ranking (Graduatoria) :: un *ranking* \(r_h\) per un votante \(v_h\) è una _sequenza ordinata_ \(\langle a_{h1}, a_{h2}, ..., a_{hn} \rangle \in \Pi(A)\) dove \(\Pi(A)\) è l'insieme di tutte
  ...
  Dato che \(>_h\) è completa e transitiva, certamente esiste un'alternativa \(\ell \in \left[ n \right]\) tale _per ogni_ altra alternativa
  ...
  *Proof:*
  ...
  Poiché \(>_h\) è *completa* deve essere vero che o \(a_{\ell} >_h a_m\) oppure \(a_m >_h a_{\ell}\) (_ma non entrambe_).\\
...
** Sistema di Voto a Torneo
   ...
   Importante osservare che in un torneo non avvengono tutti gli scontri possibili, bensì _solamente quelli programmati_ da un'*agenda*.
