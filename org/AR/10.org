...
* Modello eterogeneo
  ...
  #+caption: =A-B= /heterogeneous coordination game/ table.
  #+ATTR_HTML: :style max-width:300px; :width 100%
  [[file:../images/ar-lesson10-img3.png]]
  ...
  #+caption: Esempio giocattolo, con \(V_0 = \lbrace 1 \rbrace\).
  #+ATTR_HTML: :style max-width:450px; :width 100%
  [[file:../images/ar-lesson10-img4.png]]
  ...
  #+ATTR_HTML: :style max-width:450px; :width 100%
  [[file:../images/ar-lesson10-img5.png]]
  ...
  #+begin_quote
  *THM*
  Sia il grafo \(G=(V,E)\) e l'insieme di iniziatori \(V_0 \subseteq V\).
  L'insieme \(V_0\) *non* genera una cascata completa di =A= _se e solo so_ \(G-V_0\) congiene un /blocking cluster/.\\
  #+end_quote
...
* Azioni collettive
  ...
  Secondo questo scenario è ragionevole pensare che ogni individuo vada se _sa_ che un certo numero di altri individui partecipi.
  ...
  Più precisamente, $v$ partecila alla protesta se sa che altre \(k_v - 1\) persone partecipano[fn:1].\\

  Dato che però $v$ non può sapere l'afflusso globale (per via delle comunicazioni ristrette), possiamo dire che $v$ parteciperà alla protesta solamente se se sa che altri \(k_v - 1\) _suoi vicini_ partecipano.
  ...
  [[file:../images/ar-lesson10-img6.png]]
  ...
  #+ATTR_HTML: :style max-width:200px; :width 100%
  [[file:../images/ar-lesson10-img7.png]]
  ...
  #+ATTR_HTML: :style max-width:200px; :width 100%
  [[file:../images/ar-lesson10-img8.png]]
...
[fn:1] $v$ è il \(k_v\)-esimo partecipante.
