...
*** Teorema 2 - delimitazione inferiore
    *Enunciato:* per ogni costante $c>0$,
    ...
    \implies
    \lim_{n \rightarrow \infty} \mathcal{P}\Big( G(n,r(n)) \mbox{ è connesso} \Big) > 0
    \]
...
**** *Maggiorazione per* $\sum_{j \in \left[ n \right] \setminus \lbrace i \rbrace} \mathcal{P}\left( \mathcal{E}_{i,j} \right)$
	...
	[[file:../images/ar-lesson04-img7.png]]
     ...
     \begin{align*}
     \overline{CB}
     &= \sqrt{ \overline{t_i C}^2 + \overline{t_i B}^2 }\\
     &= \sqrt{ \left(\frac{r}{2}\right)^2 + r^2 }\\
     &= \sqrt{ r^2 \left(\frac{1}{4} + 1\right) }\\
     &= \sqrt{ r^2 \left(\frac{1}{4} + 1\right) }\\
     &= \sqrt{ \frac{5}{4}r^2}\\
     &= \frac{\sqrt{5}}{2}r 
     \end{align*}
     ...
     \[
     2\overline{CB} \times \frac{r}{2} \times \frac{1}{2} = \frac{\sqrt{5}}{4}r^2
     \]

     In conclusione l'area dell'intersezione $C_r(t_i) \cap C_r(t_j)$ sarà pari a
     \begin{align*}
       |C_r(t_i) \cap C_r(t_j)|
       &= 2 \times \left( \frac{L \times r}{2} - \frac{\sqrt{5}}{4}r^2 \right)\\
       &= 2 \times \left( \frac{\frac{2\pi}{3} r \times r}{2} - \frac{\sqrt{5}}{4}r^2 \right)\\
       &= \frac{2\pi}{3}r^2 - \frac{\sqrt{5}}{2}r^2\\
       &= 2r^2 \left( \frac{\pi}{3} - \frac{\sqrt{5}}{4} \right)
     \end{align*}
     ...
     \begin{align*}
       |C_r(t_i) \cup C_r(t_j)|
       &= 2\pi r^2 - |C_r(t_i) \cap C_r(t_j)|\\
       &\geq 2\pi r^2 - 2r^2 \left( \frac{\pi}{3} - \frac{\sqrt{5}}{4} \right)\\
       &= 2\pi r^2 - \frac{2}{3}\pi r^2 + \frac{\sqrt{5}}{2}r^2\\
       &= \frac{4}{3}\pi r^2 + \frac{\pi}{\pi} \cdot \frac{\sqrt{5}}{2}r^2\\
       &= \pi r^2 \left(\frac{4}{3} +  \frac{\sqrt{5}}{2 \pi}\right)
     \end{align*}
