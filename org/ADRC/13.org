...
**** *Fase 1*
     ...
     Per dimostrare l'alta probabilità suddividiamo la fase 1 in alrte due sottofasi, in cui verrà dimostrato l'alta probabilità della prima fase suddividendo \(1 \leq m_t \leq \alpha\log{n}\) ed \(m_t > \alpha\log{n}\) (per qualche valore di \(\alpha\)).
